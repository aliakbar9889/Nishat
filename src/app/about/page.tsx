...
const About = () => {
  return (
    <div className="w-full h-full py-32 pb-40 pt-20 px-10 mx-auto font-manrope">
      <h1 className="font-inter font-semibold text-8xl mt-10 tracking-tighter text-center">
        ABOUT NISHAT
      </h1>
      <div className="w-full border-t-[1px] border-zinc-700 mt-16 py-5 px-10" />
      ...
      <div className="w-full py-12 bg-black rounded-tl-3xl rounded-tr-3xl font-inter font-semibold text-8xl tracking-tighter text-center">
        <InfiniteMovingHeadings
          headings={['WE ARE HERE SINCE 1951']}
        />
      </div>
